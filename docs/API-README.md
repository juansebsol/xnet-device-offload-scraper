...
- **Partners / API users:** [`API-USER-GUIDE.md`](./API-USER-GUIDE.md)
- **XNET admins (key management):** [`API-ADMIN-GUIDE.md`](./API-ADMIN-GUIDE.md)
- **Key setup scripts:** [`API-KEYS.md`](./API-KEYS.md)
